...
export default async function EditRolePage({ params }: PageProps) {
  ...
  if (!role) {
    return <DashboardLayout><div className="space-y-6"><h1 className="text-3xl font-bold">Role Not Found</h1></div></DashboardLayout>;
  }
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <TeamRoleForm roleId={id} initialData={{ roleName: role.roleName, description: role.description, permissions: role.permissions || [] }} />
          </CardContent>
        </Card>
      </div>
    </DashboardLayout>
