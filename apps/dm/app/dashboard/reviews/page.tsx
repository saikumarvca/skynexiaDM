        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                View and manage actual review records across all clients. For
                the draft bank and allocation workflow, use the modules below.
              </p>
            </div>
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            <h2 className="font-medium mb-2">
              Draft &amp; Allocation Workflow
            </h2>
            <p className="text-sm text-muted-foreground mb-3">
              Suggested Comment Bank → Allocate to Team → Share with Customer →
              Customer Posts → Mark as Used
            </p>
