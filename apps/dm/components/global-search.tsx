...
import type { SearchItem } from "./global-search/types";
import { ALL_ITEMS, GROUPS } from "./global-search/data";
import { useLiveSearch } from "./global-search/useLiveSearch";
...
export function GlobalSearch({
  ...
  const { results: liveResults, loading: liveLoading, error: liveError } =
    useLiveSearch(query);
