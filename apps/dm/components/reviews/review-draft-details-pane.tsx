    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Client: {clientName(draft)}</p>
        </div>

        <div>
          <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">Full Review Text</p>
          <p className="mt-1 text-sm whitespace-pre-wrap rounded-md bg-muted/50 p-3">{draft.reviewText}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div>
            ...
            <p className={isUsed ? "text-amber-600 dark:text-amber-400 font-medium" : "text-green-600 dark:text-green-400"}>
              {isUsed ? "Used" : "Unused"}
            </p>
          </div>
          <div>
        ...
        <div className="border-t pt-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => onDuplicate(draft._id)}>
            ...
            <Button variant="outline" size="sm" onClick={() => onViewHistory(draft)}>
